...
# booking1 = BookingModel(**booking) # dict unpacking
# print("\n===Booking Model===\n")
# print(booking1)
...
# address = Address(street="abc street california",city="newyork", postal_code='123')
# user = User(id=1, name="Muniba", address=address)
...
lesson2 = Lesson(lesson_id=23, topic="agent as a tool")
lesson3 = Lesson(lesson_id=11,topic="Algebra")
module = Module(module_id=56, name="Agentic patterns", lessons=[lesson,lesson2])
module2 = Module(module_id=120, name="maths",lessons=[lesson3])
course = Course(course_id=35,title="openai agents sdk", modules=[module,module2])
print("\n===Course Model===\n")
print(lesson)
print(module)
print(course)